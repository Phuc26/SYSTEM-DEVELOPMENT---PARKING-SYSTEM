						...
						<div class="mb-2"> 
		              	...
		              	<div class="mb-3"> 
		               	...
		               	<div class="mb-3"> 
							...
							<input type="password" class="form-control mb-3" name="passwordconfirm" required>
		               	</div>
					...
					<div class="col-md-6">
						...
						<div class="mb-2"> 
							<label for="firstname" class="form-label">First Name*</label>
		                  	<input type="text" class="form-control" name="firstname" value="<?php echo isset($_POST["firstname"]) ? $_POST["firstname"] : ''; ?>" required>
		              	</div>

		              	<div class="mb-3"> 
		                  	<label for="lastname" class="form-label">Last Name*</label>
							<input type="password" class="form-control mb-3" name="lastname" value="<?php echo isset($_POST["lastname"]) ? $_POST["lastname"] : ''; ?>" required>
		               	</div>

		               	<div class="mb-3"> 
		                  	<label for="email" class="form-label">Email Address</label>
							<input type="email" class="form-control mb-3" name="email" value="<?php echo isset($_POST["email"]) ? $_POST["email"] : ''; ?>">
		               	</div>
